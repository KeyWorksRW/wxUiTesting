...
bool SdiFrame::Create(wxDocManager* manager, wxFrame* parent, wxWindowID id, const wxString& title,
    const wxPoint& pos, const wxSize& size, long style, const wxString &name)
{

    if (!wxDocParentFrame::Create(manager, parent, id, title, pos, size, style, name))
    {
        return false;
    }
