...
constexpr const auto txtVersion = "mdi_test 1.0.327";
constexpr const auto txtCopyRight = "Copyright (c) 2020-2025 KeyWorks Software (Ralph Walden)";
constexpr const auto txtAppname = "mdi_test";
