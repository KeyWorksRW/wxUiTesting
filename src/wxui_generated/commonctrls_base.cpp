...
bool CommonCtrlsBase::Create(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size,
                             long style, const wxString& name)
{
    ...
    m_choice2 =
        new wxChoice(static_box_sizer3->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr, wxCB_SORT);
    ...
    m_checkList2 = new wxCheckListBox(static_box_sizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0,
                                      nullptr, wxLB_SINGLE | wxLB_SORT);
    ...
    m_staticText11 =
        new wxStaticText(this, wxID_ANY, "On Windows 10, the items may be be clipped unless they have a trailing space.");
    ...
    m_bmpComboBox =
        new wxBitmapComboBox(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, wxCB_READONLY);
    ...
    m_animation_ctrl = new wxAnimationCtrl(static_box_2->GetStaticBox(), wxID_ANY,
                                           GetAnimFromHdr(clr_hourglass_gif, sizeof(clr_hourglass_gif)));
