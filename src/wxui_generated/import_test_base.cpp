...
bool ImportTest::Create(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size,
                        long style, const wxString& name)
{
    ...
    m_panel_import_crafter =
        new ImportCrafterBase(m_splitter_2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
