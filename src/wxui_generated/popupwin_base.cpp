...
PopupWinBase::PopupWinBase(wxWindow* parent, int style) : wxPopupTransientWindow(parent, style)
{
    ...
    m_staticText =
        new wxStaticText(this, wxID_ANY,
                         "This is a wxPopupTransientWindow set to use a raised border around it. Note that the default is "
                         "to not have a border at all.\n\nBTW, right-click anywhere in the dialog to get a popup menu for "
                         "changing some of the control values.\n\nClick outside this window to dismiss it.");
