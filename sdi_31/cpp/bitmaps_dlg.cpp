...
#endif  // requires wxCHECK_VERSION(3, 1, 6)
    ...
    const wxPoint& pos, const wxSize& size, long style, const wxString &name)
{
    ...
    m_tool_bar->AddTool(wxID_ANY, "one",
#if wxCHECK_VERSION(3, 1, 6)

        wxueImage(wxue_img::wxPython_2x_png, sizeof(wxue_img::wxPython_2x_png))
#else
        wxBitmap(wxueImage(wxue_img::wxPython_2x_png, sizeof(wxue_img::wxPython_2x_png)))
#endif
    );

    m_tool_bar->AddTool(wxID_ANY, "two",
#if wxCHECK_VERSION(3, 1, 6)
    ...
    m_tool_bar->AddTool(wxID_ANY, "three",
#if wxCHECK_VERSION(3, 1, 6)
        [&]()
    {
    ...
    m_tool_bar->AddTool(wxID_ANY, "xpm",
#if wxCHECK_VERSION(3, 1, 6)
        wxImage(english_xpm)
#else
        wxBitmap(wxImage(english_xpm))
#endif
    );
    ...
    m_tool_bar->AddTool(wxID_ANY, "art",
#if wxCHECK_VERSION(3, 1, 6)
...
#if wxCHECK_VERSION(3, 1, 6)
        wxBitmapBundle::FromBitmap(wxueImage(wxue_img::wxPython_2x_png, sizeof(wxue_img::wxPython_2x_png)))
#else
        wxueImage(wxue_img::wxPython_2x_png, sizeof(wxue_img::wxPython_2x_png))
#endif
    );
    ...
    grid_sizer->Add(bmp, wxSizerFlags().Border(wxALL));
        ...
        auto* bmp2 = new wxStaticBitmap(this, wxID_ANY, 
#if wxCHECK_VERSION(3, 1, 6)
    ...
    grid_sizer->Add(bmp2, wxSizerFlags().Border(wxALL));
        ...
        auto* bmp3 = new wxStaticBitmap(this, wxID_ANY, 
#if wxCHECK_VERSION(3, 1, 6)
    ...
    grid_sizer->Add(bmp3, wxSizerFlags().Border(wxALL));
        ...
        auto* bmp4 = new wxStaticBitmap(this, wxID_ANY, 
#if wxCHECK_VERSION(3, 1, 6)
            wxBitmapBundle::FromBitmap(wxImage(english_xpm)));
#else
        wxBitmap(wxImage(english_xpm)));
#endif
    grid_sizer->Add(bmp4, wxSizerFlags().Border(wxALL));

        auto* bmp5 = new wxStaticBitmap(this, wxID_ANY, 
#if wxCHECK_VERSION(3, 1, 6)
            wxueBundleSVG(wxue_img::wxPython_svg, 1648, 6310, wxSize(16, 16)));
#else
        wxBitmap(wxNullBitmap /* SVG images require wxWidgets 3.1.6 */));
#endif
    grid_sizer->Add(bmp5, wxSizerFlags().Border(wxALL));

        auto* bmp6 = new wxStaticBitmap(this, wxID_ANY, 
#if wxCHECK_VERSION(3, 1, 6)
